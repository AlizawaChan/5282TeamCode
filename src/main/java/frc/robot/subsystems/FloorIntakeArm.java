...
public static class FloorIntakeArmUp extends RunCommand { /*This is a command class within the original class.  
  ...
  public FloorIntakeArmUp(FloorIntakeArm subsystem) { //rename the method name custom to your subsystem.  Two public methods cannot be named the same.
    super(subsystem::FloorIntakeArmUp, subsystem); //rename the method name custom to your subsystem.
...
public static class FLoorIntakeArmDown extends RunCommand { /*This is a command class within the original class.  
  You will need to change the class name.  Its not how we ordinarily code but chat GPT did it and it works so we will keep it. */
  private final FloorIntakeArm subsystem;

  public FLoorIntakeArmDown(FloorIntakeArm subsystem) { //rename the method name custom to your subsystem.  Two public methods cannot be named the same.
